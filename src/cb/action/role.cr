...
module CB::Action
  ...
  class RoleUpdate < RoleAction
    ...
    def run
      ...
      raise Error.new("invalid role '#{@role_name}'") unless CB::VALID_CLUSTER_ROLES.includes? @role_name
      if @role_name == "user"
